...
<head>
  ...
  <link rel="stylesheet" href="\RameinCuy\public\PostingEvent.css">
</head>
<body class="body-page2 bg-light position-relative">
  ...
  <form action="index.php?page=postingEvent&action=createEventDetails" method="POST" enctype="multipart/form-data">
    <section class="upload-section py-4">
      ...
      <div class="container-fluid" style="max-width: 480px;">
        <div id="imagePreview" class="image-preview-container">
          ...
          <img id="previewImg" src="\RameinCuy\View\Images\imagepng.png" alt="Preview" class="preview-image d-none">
        </div>
